package scripts.woodcutting_oak_draynor;
...
import scripts.woodcutting_oak_draynor.phases.DraynorBankPhase;
import scripts.woodcutting_oak_draynor.phases.DraynorOakPhase;
...
@Script.Manifest(name = "woodcutting_DraynorOakChopper", description = "woodcutting_DraynorOakChopper", properties = "client=4; topic=051515; author=Bowman")
public class DraynorOakChopper extends PollingScript<ClientContext> implements MessageListener, PaintListener {
    ...
    public void start() {
        ...
        // Phase
        DraynorOakPhase oakPhase = new DraynorOakPhase(ctx, "CUT");
        DraynorBankPhase bankingPhase = new DraynorBankPhase(ctx, "BANK", axeId);

        // Phase Transitions
        oakPhase.setNextPhase(bankingPhase);
        bankingPhase.setNextPhase(oakPhase);
    ...
    public void repaint(Graphics g) {
        ...
        g.drawString("Logs cut: " + logCount, GuiHelper.getDialogMiddleX(), GuiHelper.getDialogStartY(3));
