...
import disabled.combat_cows.phases.CombatPhase;
...
public class CowKillerAIO extends PollingScript<ClientContext> implements MessageListener, PaintListener {
    ...
    //region Actions
    private AbstractAction combatCowAction;
    private AbstractAction healAction;
    private AbstractAction equipArrows;
    private AbstractAction lootAction;
    //endregion
