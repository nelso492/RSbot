    ...
    public void start() {
        ...
        switch( i.id() ) {
            ...
            case Items.BRACELET_MOULD_11065:
                // Bracelet Mould
                config = new CraftComponentConfig(446, 46, -1, "Make");
                xpPerCraft = 25;
        ...
        // Bank
        bankAction = new BankAction(ctx, "Banking", craftedItemId, -1, barId, 28, -1,-1, false,true,false, CommonAreas.edgevilleBankNorth());
